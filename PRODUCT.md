...
- **Routes:** `/` (single-page: Hero, About, Experience, Projects, Notes, Certifications, Contact), `/blog`, `/blog/[slug]`, `/stats` (weekly last.fm charts), `/fun` (manga/anime/novels + now-playing music), `/rss.xml`, sitemap, `/404`; old routes (`/projects`, `/experience`, `/about`, `/contact`, `/tags`, `/id/*`) redirect to their single-page anchors
