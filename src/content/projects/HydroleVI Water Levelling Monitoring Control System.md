---
title: 'HydroleVI (Water Levelling Monitoring Control System)'
...
- Designed a three-level alert system with escalating warning mechanisms
- Assisted in assembling electronic components according to schematic designs
- Developed a Teams page website using the Laravel framework for centralized system information and alerts
- Integrated real-time monitoring capabilities with Blynk for remote accessibility
