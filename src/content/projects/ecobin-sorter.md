...
This bin decides before it swallows: on ESP32, a sensor pass classifies trash as dry, wet, or metal, then servo-controlled gates and a conveyor route each type to its compartment.
